 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pe(e){le(new r.wA("platform-logger",(e=>new R(e)),"PRIVATE")),le(new r.wA("heartbeat",(e=>new Re(e)),"PRIVATE")),ve(x,O,e),ve(x,O,"esm2017"),ve("fire-js","")}Pe("")},8463:function(e,t,n){"use strict";n.d(t,{H0:function(){return u},wA:function(){return i}});var r=n(4444);class i{constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function mt(e,t){return P(e,"POST","/v1/accounts:signUp",x(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ot(e,t){return O(e,"POST","/v2/accounts/mfaEnrollment:start",x(e,t))}function Dt(e,t){return O(e,"POST","/v2/accounts/mfaEnrollment:finalize",x(e,t))}function Pt(e,t){return O(e,"POST","/v2/accounts/mfaEnrollment:start",x(e,t))}function Lt(e,t){return O(e,"POST","/v2/accounts/mfaEnrollment:finalize",x(e,t))}new WeakMap;const Mt="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yn(e,t){return O(e,"POST","/v2/accounts/mfaSignIn:start",x(e,t))}function vn(e,t){return O(e,"POST","/v2/accounts/mfaSignIn:finalize",x(e,t))}function wn(e,t){return O(e,"POST","/v2/accounts/mfaSignIn:finalize",x(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _o=new Wi(Ci.comparator);function Eo(){return _o}const To=new Wi(Ci.comparator);function Io(...e){let t=To;for(const n of e)t=t.insert(n.key,n);return t}function ko(e){let t=To;return e.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function So(){return Ao()}function Co(){return Ao()}function Ao(){return new bo((e=>e.toString()),((e,t)=>e.isEqual(t)))}const Ro=new Wi(Ci.comparator),No=new Xi(Ci.comparator);function xo(...e){let t=No;for(const n of e)t=t.add(n);return t}const Oo=new Xi(wi);function Do(){return Oo}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xc{constructor(){this.lr=new Xi(Oc.hr),this.Pr=new Xi(Oc.Ir)}isEmpty(){return this.lr.isEmpty()}addReference(e,t){const n=new Oc(e,t);this.lr=this.lr.add(n),this.Pr=this.Pr.add(n)}Tr(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.Er(new Oc(e,t))}dr(e,t){e.forEach((e=>this.removeReference(e,t)))}Ar(e){const t=new Ci(new Ii([])),n=new Oc(t,e),r=new Oc(t,e+1),i=[];return this.Pr.forEachInRange([n,r],(e=>{this.Er(e),i.push(e.key)})),i}Rr(){this.lr.forEach((e=>this.Er(e)))}Er(e){this.lr=this.lr.delete(e),this.Pr=this.Pr.delete(e)}Vr(e){const t=new Ci(new Ii([])),n=new Oc(t,e),r=new Oc(t,e+1);let i=xo();return this.Pr.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new Oc(e,0),n=this.lr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class Oc{constructor(e,t){this.key=e,this.mr=t}static hr(e,t){return Ci.comparator(e.key,t.key)||wi(e.mr,t.mr)}static Ir(e,t){return wi(e.mr,t.mr)||Ci.comparator(e.key,t.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fc{constructor(e,t){this.Nr={},this.overlays={},this.Br=new Ui(0),this.Lr=!1,this.Lr=!0,this.referenceDelegate=e(this),this.kr=new Mc(this),this.indexManager=new Ec,this.remoteDocumentCache=function(e){return new Pc(e)}((e=>this.referenceDelegate.qr(e))),this.serializer=new wc(t),this.Qr=new Rc(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Lr=!1,Promise.resolve()}get started(){return this.Lr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new Nc,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.Nr[e.toKey()];return n||(n=new Dc(t,this.referenceDelegate),this.Nr[e.toKey()]=n),n}getTargetCache(){return this.kr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Qr}runTransaction(e,t,n){Zr("MemoryPersistence","Starting transaction:",e);const r=new Uc(this.Br.next());return this.referenceDelegate.Kr(),n(r).next((e=>this.referenceDelegate.$r(r).next((()=>e)))).toPromise().then((e=>(r.raiseOnCommittedEvent(),e)))}Ur(e,t){return Mi.or(Object.values(this.Nr).map((n=>()=>n.containsKey(e,t))))}}class Uc extends Pi{constructor(e){super(),this.currentSequenceNumber=e}}class Vc{constructor(e){this.persistence=e,this.Wr=new xc,this.Gr=null}static zr(e){return new Vc(e)}get jr(){if(this.Gr)return this.Gr;throw ri()}addReference(e,t,n){return this.Wr.addReference(n,t),this.jr.delete(n.toString()),Mi.resolve()}removeReference(e,t,n){return this.Wr.removeReference(n,t),this.jr.add(n.toString()),Mi.resolve()}markPotentiallyOrphaned(e,t){return this.jr.add(t.toString()),Mi.resolve()}removeTarget(e,t){this.Wr.Ar(t.targetId).forEach((e=>this.jr.add(e.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next((e=>{e.forEach((e=>this.jr.add(e.toString())))})).next((()=>n.removeTargetData(e,t)))}Kr(){this.Gr=new Set}$r(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Mi.forEach(this.jr,(n=>{const r=Ci.fromPath(n);return this.Hr(e,r).next((e=>{e||t.removeEntry(r,Ei.min())}))})).next((()=>(this.Gr=null,t.apply(e))))}updateLimboDocument(e,t){return this.Hr(e,t).next((e=>{e?this.jr.delete(t.toString()):this.jr.add(t.toString())}))}qr(e){return 0}Hr(e,t){return Mi.or([()=>Mi.resolve(this.Wr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ur(e,t)])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
