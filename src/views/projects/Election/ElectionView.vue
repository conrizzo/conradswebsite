  ...
  <div class="main-container center-with-flex">
    <div class="inner-container-width">
      ...
      <section>
        ...
        <ul>
          <li><a class="text-links" target="_blank"
              href="https://projects.fivethirtyeight.com/2024-election-forecast/">Model Prediction</a></li>

          <div style="margin-left: 1rem; margin-top: 0.25rem;">
            <span style="font-weight: bold; border-bottom: 1px solid gainsboro;">Battleground States</span>
            <li><a class="text-links" target="_blank"
      ...
      <section>
        <h2>270towin</h2>
        <div class="align-text-left">
          <a class="text-links" target="_blank" href="https://www.270towin.com/">https://270towin.com</a> - convenient
          click and change map to analyze the U.S election electoral college point math
        </div>
      </section>
