...
export default [
  ...
  { id: 7, text: 'Full Stack Blackjack Game', to: '/projects/cards', caption: "This is now a fullstack game with all game logic running 100% serverside in python with gamestate in a Redis database. As of July 2024 almost completely working.", imageSrc: "https://next.conradswebsite.com/images/conradswebsite_images/7card.jpg" },
