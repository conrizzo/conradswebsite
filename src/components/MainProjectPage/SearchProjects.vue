            ...
            <div class="search-container">
                ...
                <div class="input-container">
                    ...
                    <input :class="{ 'remove-bottom-border-radius': searchTerm.length > 0 && filteredItems.length > 0 }"
                        ref="inputField" type="text" v-model="searchTerm" placeholder="Search projects...">
                        
                </div>
                <RouterLink :to="item.to" class="format-search-links" v-for="item in filteredItems" :key="item.id">
...
.format-search-links {
  ...
  width: 100%;
  padding-left: 2.2rem;
  z-index: 10; /* put search results in front of all other content on the screen */
}
